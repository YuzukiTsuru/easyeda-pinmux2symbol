...
2. EasyEDA プロ版の拡張機能マネージャーで `build/dist/pinmux2symbol_v1.1.10.eext` をインポートします。
...
- Bank および MUX テーブルの文字は太字の `Courier New`。ピン名とピン番号の属性は既定で標準ウェイトの `Arial`、`0.08 inch`、`#A2A2A2` を使用します。
